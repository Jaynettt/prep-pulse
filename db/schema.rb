...
ActiveRecord::Schema[7.2].define(version: 2024_10_10_084411) do
  ...
  create_table "questions", force: :cascade do |t|
    t.string "content"
    t.bigint "pulse_category_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["pulse_category_id"], name: "index_questions_on_pulse_category_id"
  end
  ...
  add_foreign_key "questions", "pulse_categories"
